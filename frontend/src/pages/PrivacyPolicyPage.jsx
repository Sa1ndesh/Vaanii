    ...
    <div className="min-h-screen font-sans" style={{ backgroundColor: softGray }}>
      ...
      <main className="max-w-4xl mx-auto py-16 px-6 bg-white my-12 rounded-lg shadow-lg border border-gray-200">
        ...
        <div className="mt-10 space-y-6 text-gray-700">
          <p>
            Vani-Kanoon respects your privacy. We collect minimal personal information to provide legal AI assistance.
          </p>
          <h2 className="text-xl font-bold" style={{ color: deepBlue }}>Contact Us</h2>
          <p>
            For privacy inquiries, please contact: <a href="mailto:sandeshbirannavar@gmail.com" className="text-blue-600 hover:underline">sandeshbirannavar@gmail.com</a>
          </p>
        </div>
      </main>
